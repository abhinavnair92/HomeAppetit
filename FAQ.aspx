<%@ Page Title="FAQs" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FAQ.aspx.cs" Inherits="FAQ" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div style="background-color: rgba(255,255,255,0.9); padding-left: 8px; border-radius: 10px; padding-top: 1px; padding-bottom: 5px;">
     ...
     Each plate is designed to be a well-balanced, healthy meal.  In addition, each delivery comes with beautifully printed recipe cards and step-by-step instructions. 
        ...
        <div class="FAQ" onclick="toggle('faq2')" style="background-color: rgba(255,255,255,1); border-radius:10px">
        ...
        <div class="FAQ" onclick="toggle('faq3')" style="background-color: rgba(255,255,255,1); border-radius:10px">
        ...
        <div class="FAQ" onclick="toggle('faq4')" style="background-color: rgba(255,255,255,1); border-radius:10px">
        ...
        <div class="FAQ" onclick="toggle('faq5')" style="background-color: rgba(255,255,255,1); border-radius:10px">
        ...
        <div class="FAQ" onclick="toggle('faq6')" style="background-color: rgba(255,255,255,1); border-radius:10px">
     ...
     However, we always recommend cooking fish and seafood first to make sure it remains at its peak freshness.
        ...
        <div class="FAQ" onclick="toggle('faq7')" style="background-color: rgba(255,255,255,1); border-radius:10px">
        ...
        <div class="FAQ" onclick="toggle('faq8')" style="background-color: rgba(255,255,255,1); border-radius:10px">
        ...
        <br />
        <br />
        <p style="font-style: italic; font-size: large; color: Black">Delivery </p>
        <div class="FAQ" onclick="toggle('faq9')" style="background-color: rgba(255,255,255,1); border-radius:10px">
     ...
     <br />
        ...
        <div class="FAQ" onclick="toggle('faq10')" style="background-color: rgba(255,255,255,1); border-radius:10px">
     ...
     When you sign up and enter your zip code, you’ll see which delivery windows are available in your area at this time.  If you need any additional information, please don’t hesitate to contact us! 
        ...
        <div class="FAQ" onclick="toggle('faq11')" style="background-color: rgba(255,255,255,1); border-radius:10px">
        ...
        <div class="FAQ" onclick="toggle('faq12')" style="background-color: rgba(255,255,255,1); border-radius:10px">
     ...
     Since our food is packaged with insulated liners and gel packs, it will remain cold and fresh for you until you get home later that evening.  If you live in Manhattan, you may be able to provide additional delivery instructions when creating your account, such as asking the package to be left with a doorman or neighbor.
        ...
        <div class="FAQ" onclick="toggle('faq13')" style="background-color: rgba(255,255,255,1); border-radius:10px">
        ...
        <br />
        <br />
        <p style="font-style: italic; font-size: large; color: black">About your account </p>

        <div class="FAQ" onclick="toggle('faq14')" style="background-color: rgba(255,255,255,1); border-radius:10px">
        ...
        <div class="FAQ" onclick="toggle('faq15')" style="background-color: rgba(255,255,255,1); border-radius:10px">
        ...
        <div class="FAQ" onclick="toggle('faq16')" style="background-color: rgba(255,255,255,1); border-radius:10px">
        ...
        <div class="FAQ" onclick="toggle('faq17')" style="background-color: rgba(255,255,255,1); border-radius:10px">
        ...
        <div class="FAQ" onclick="toggle('faq18')" style="background-color: rgba(255,255,255,1); border-radius:10px">
