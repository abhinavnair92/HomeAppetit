...
<div style =" font-style:italic; font-weight:bold" >How long will the food stay fresh for?</div>
 <div id="faq6" class="ANS">Our meals are designed to stay fresh for the week in which you order them.  
     However, we always recommend cooking fish and seafood first to make sure it remains at its peak freshness.</div>
</DIV>
...
<div style =" font-style:italic; font-weight:bold" >When you have extra food, what do you do with it?</div>
 ...
 <div id="faq9" class="ANS">We currently deliver to most of the United States including the following states: CA, CT, DC, DE, FL, ID, IL, IN, KY, MA, ME, MD, NH, NJ, NV, NY, OH, OR, PA, RI, TN, VA, VT, WA, WV. 
     ...
     <br />
If we are not available in your area yet, create an account and we will notify you when we launch in your zip code! </div>
</DIV>

    <DIV class="FAQ" onclick="toggle('faq10')">
<div style =" font-style:italic; font-weight:bold" >When will my package arrive? </div>
 <div id="faq10" class="ANS">Depending on your location, we offer daytime and/or evening deliveries.  
     When you sign up and enter your zip code, you’ll see which delivery windows are available in your area at this time.  If you need any additional information, please don’t hesitate to contact us!  </div>
</DIV>
...
<div style =" font-style:italic; font-weight:bold" >What happens if I am not home? </div>
 <div id="faq12" class="ANS">If you aren’t home, our delivery person will generally leave the package for you at your door.   
     Since our food is packaged with insulated liners and gel packs, it will remain cold and fresh for you until you get home later that evening.  If you live in Manhattan, you may be able to provide additional delivery instructions when creating your account, such as asking the package to be left with a doorman or neighbor.</div>
</DIV>
