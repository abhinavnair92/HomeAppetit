<%@ Page Title="Recipe" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="asp.aspx.cs" Inherits="Recipe1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div style="background-color: rgba(255,255,255,0.9); padding-left: 12px; border-radius: 10px; padding-top: 21px; padding-bottom: 5px; height: 846px;">
        <div id="Sec1" style="position: relative; left: 80px; top: -4px; height: 291px;">
            ...
            <asp:Image ID="asp" runat="server" ImageUrl="~/Assets/RecipeImages/asp.JPG" ImageAlign="Middle" Height="232px" Width="356px" />
           
            <h1 style="text-align: left; position: inherit; top: -289px; left: 466px; width: 500px"><br />Asparagus, Mushroom, and Sweet Bell Pepper Pasta with Goat Cheese</h1>
