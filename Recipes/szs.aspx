<%@ Page Title="Recipe" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="szs.aspx.cs" Inherits="Recipes_szs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div style="background-color: rgba(255,255,255,0.9); padding-left: 12px; border-radius: 10px; padding-top: 21px; padding-bottom: 5px; height: 846px;">
        <div id="Sec1" style="position: relative; left: 80px; top: -4px; height: 291px;">
            <asp:Image ID="szs" runat="server" ImageUrl="~/Assets/RecipeImages/szs.JPG" ImageAlign="Middle" />
           
            <h1 style="text-align: left; position: inherit; top: -289px; left: 466px; width: 500px"><br />Szechwan Shrimps</h1>
           
            <p style="text-align: left; position: inherit; top: -289px; left: 466px; width: 550px; color: black">Don't let some of the ingredients fool you -- this spicy shrimp makes a simple, impressive dish. </p>
