<%@ Page Title="Recipe" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="rrc.aspx.cs" Inherits="Recipes_rrc" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <div style="background-color: rgba(255,255,255,0.9); padding-left: 12px; border-radius: 10px; padding-top: 21px; padding-bottom: 5px; height: 846px;">
        <div id="Sec1" style="position: relative; left: 80px; top: -4px; height: 291px;">
            <asp:Image ID="rrc" runat="server" ImageUrl="~/Assets/RecipeImages/rrc.JPG" ImageAlign="Middle" />
           
            <h1 style="text-align: left; position: inherit; top: -289px; left: 466px; width: 500px"><br />Rosemary Ranch Chicekn Kabobs</h1>
           
            <p style="text-align: left; position: inherit; top: -289px; left: 466px; width: 550px; color: black">Delicious, tender, and juicy chicken that will melt in your mouth. Even the most picky eater will be begging for the last piece.</p>
        ...
        <div class='ingredients-list' style="position: relative; left: 80px; top: 0px; width: 404px;">
            ...
            <ul>
                ...
                <li itemprop='ingredients'>1 lb chicken</li>
        ...
        <div class='recipe-list' style="position: relative; left: 548px; top: -327px; width: 550px;">
            ...
            <ol>
                <li itemprop='step1'>Bring a large pot of salted water (1/2 tablespoon salt) to a boil over high heat.</li>
                <br />
