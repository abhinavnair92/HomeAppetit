                ...
                <section id="loginForm">
                    <div class="form-horizontal">
                        ...
                        <div class="form-group">
                            <asp:Label ID="Label1" runat="server" AssociatedControlID="UserName" CssClass="col-md-2 control-label" style="color: #333333">User name</asp:Label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <asp:Label ID="Label2" runat="server" AssociatedControlID="Password" CssClass="col-md-2 control-label" style="color: #333333">Password</asp:Label>
                            <div class="col-md-10">
                        ...
                        <div class="form-group">
                            <div class="col-md-offset-2 col-md-10">
                                <div class="checkbox">
                                    ...
                                    <asp:Label ID="Label3" runat="server" AssociatedControlID="RememberMe" style="color: #333333">Remember me?</asp:Label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
