...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <br />
    <div style="background-color: #FFFFCC; padding-left: 8px; border-radius:10px; padding-top:1px;">
    <h2><%: Title %>.</h2>
    ...
    <p style="text-align: justify; left:5px; width: 973px; padding-left: 7px; padding-right: 0px;">We know how busy you are, we know how important it is to be healthy, we were in your shoes. 
        ...
        but they knew 
        how important it was to eat healthy. Thus HomeAppetit was born.</p>
    <p style="text-align: justify; width: 971px; padding-left: 7px; padding-right: 0px;">We are dedicated to bringing you the taste of home and the healthy alternative to eating out. We bring you the ingredients fresh and all you need to do is follow the simple recipe provided to enjoy a great meal.</p>
